...
1. В случае необходимости обратитесь к [официальной докуления двух временных файлов.
    * `Moved and deleted` — после удаления и перментации](https://git-scm.com/book/ru/v2/Основы-Git-Запись-изменений-в-репозиторий) — здесь подробно описано, как выполнить следующие шаги. 
...
1. В результате предыдущих шагов в репозитории должно быть как минимум пять коммитов (если вы сделали ещё промежуточные — нет проблем):
    ...
    * `Prepare to delete and move` — после добавемещения временных файлов. 
...
18.  Опишем файл  Terraform.gitignore, приведенный в домашнем задании. Terraform.gitignore - это готовый шаблон файла .gitignore специально для Terraform-проектов.
    Согласно файлу будут проигнорированы следующие типы файлов:
    .terraform/  - игнорировать папку .terraform и всё её содержимое.
    *.tfstate - игнорировать все файлы с расширением tfstate
    *.tfstate.* - игнорировать все файлы, в имени которых есть  .tfstate. 
    crash.log - игнорировать все файлы с именем crash и с расширением log
    crash.*.log - игнорировать все файлы с именем crash и с расширением *.log (вместо звездочки еще любое расширение)
    *.tfvars - игнорировать все файлы с расширением tfvars
    *.tfvars.json - игнорировать все файлы с расширением tfvars.json
    override.tf - игнорировать все файлы с именем override и с расширением tf
    override.tf.json - игнорировать все файлы с именем override и с расширением tf.json
    *_override.tf - игнорировать все файлы, в имени которых есть _override и с расширением tf
    *_override.tf.json - игнорировать все файлы, в имени которых есть *_override и с расширением tf.json
    .terraformrc - игнорировать все файлы, заканчивающиеся на .terraformrc
    terraform.rc - игнорировать все файлы с именем terraform и с расширением rc
    
    Данный шаблон ghfdbk удобно использовать. Для этого в файл .gitignore добавляют следующие строки:
    
   `[include]`
       `path = gitignore/Terraform.gitignore`
