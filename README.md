...
18.  В будущем благодаря добавленному `.gitignore` будут проигнорированы файлы, находящиеся в указанные в этом файле.   
    Например в своем курсовом проекте в файле `.gitignore` я указал файлы и директории, содежащие чувстаительную информацию, выгрузка которой в публичный репозиторий недопустима:
    ...
    Я заполнил данными  файлы .gitignore в основной директории данного домашнего задания и в директориии `terraform`. 
